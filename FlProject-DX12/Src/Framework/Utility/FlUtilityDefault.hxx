...
namespace Def // Only Constexpr Value
{
	...
	constexpr auto Freame{ 60U };

	constexpr short ShortZero{ 0 };
	constexpr short ShortOne { 1 };

	constexpr unsigned short UShortZero { 0U };
	constexpr unsigned short UShortOne  { 1U };
